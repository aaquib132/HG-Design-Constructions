    ...
    return (
        <section ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-20 text-center px-4 max-w-6xl mx-auto mt-0 md:mt-10">
                <div ref={addToTextRefs} className="opacity-0 translate-y-10 mb-4 md:mb-6">
                ...
                >
                    <a href="#contact" className="group relative inline-flex items-center justify-center px-8 py-4 text-base font-bold text-hgDark transition-all duration-300 bg-hgGold hover:bg-white rounded-none focus:outline-none overflow-hidden">
                        <span className="relative uppercase tracking-widest">Book Consultation</span>
                        <FaArrowRight className="ml-3 group-hover:translate-x-1 transition-transform" />
                    </a>
                    <a href="#portfolio" className="group relative inline-flex items-center justify-center px-8 py-4 text-base font-bold text-white border border-white/20 hover:border-hgGold hover:text-hgGold transition-all duration-300 rounded-none overflow-hidden">
